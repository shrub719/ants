...
class Simulation():
    def __init__(self, SimulationParameters):
        ...
        self._Pheromones = []
        self._Grid = []
        self._TotalFoodCollected = 0
        self._FoodCollectedThisStage = 0
        Row = 0
        Column = 0
    ...
    def UpdateCollectedFood(self, Amount):
        self._TotalFoodCollected += Amount
        self._FoodCollectedThisStage += Amount

    def ResetCollectedFood(self):
        self._FoodCollectedThisStage = 0
    ...
    def GetDetails(self):
        ...
        Details += f"\nTotal food collected: {self._TotalFoodCollected}\nFood collected this stage: {self._FoodCollectedThisStage}\n"
        return Details
